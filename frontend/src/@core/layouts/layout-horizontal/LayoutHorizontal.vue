<template>
  <div class="horizontal-layout" :class="[layoutClasses]" :data-col="isNavMenuHidden ? '1-column' : null" style="height: inherit">
    <!-- NAVBAR -->
    <b-navbar
      :style="{
...
export default {
  ...
  setup() {
    ...
    // Vertical Menu
    const { isVerticalMenuActive, toggleVerticalMenuActive, overlayClasses, resizeHandler } = useVerticalLayout(navbarType, footerType);
