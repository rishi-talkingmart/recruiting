...
(function (global, factory) {
  ...
  var Upload = {
    ...
    render: function render() {
      ...
      return h("div", [h("AUpload", helper([{}, ctx, {
        "on": {
      ...
      })]) : null, getSlot(this.$slots, ['default'])]), h("aModal", {
        "attrs": {
  ...
  var Frame = {
    ...
    render: function render() {
      ...
      })]), h("aModal", helper([{}, _objectSpread2({
        width: width,
        title: title
      }, this.modal), {
        "attrs": {
  ...
  var getType = function getType(ctx) {
  ...
  var datePicker = {
    ...
    maker: function () {
      return ['date', 'month', 'week'].reduce(function (initial, type) {
        ...
        dateRange: creatorFactory(name$1, {
          type: 'range'
        }),
        datetimeRange: creatorFactory(name$1, function (m) {
          return m.props({
            type: 'range',
            showTime: true
          });
  ...
  function getFormat$1(ctx) {
    return ctx.prop.props.format || (ctx.el ? ctx.el.format : '') || 'HH:mm:ss';
  }
  var timePicker = {
    name: 'timePicker',
    toFormValue: function toFormValue(value, ctx) {
      return value ? toMoment$1(value, getFormat$1(ctx)) : null;
    },
    toValue: function toValue(formValue, ctx) {
      return formValue ? formValue.format(getFormat$1(ctx)) : formValue;
    }
  };
  ...
  var parsers = [checkbox, datePicker, hidden, input, timePicker, tree, radio, select, row];
  ...
  var manager = {
    ...
    makeInfo: function makeInfo(rule, uni) {
      ...
      if (!isFalse(infoProp.show) && (infoProp.info || infoProp["native"]) && !isFalse(infoProp.icon)) {
        ...
        var field = isTool ? 'title' : 'content';
        ...
        children[infoProp.align !== 'left' ? 'unshift' : 'push'](this.$r(mergeProps([infoProp, prop]), [this.$r({
          type: 'icon',
          props: {
            type: infoProp.icon === true ? 'question-circle-o' : infoProp.icon
          },
          key: "".concat(uni, "i")
        })]));
      }
  ...
  function useAlias(maker) {
    ['upload', 'frame', 'autoComplete', 'cascader', 'datePicker', 'frame', 'inputNumber', 'radio', 'rate', 'switch', 'rate', 'slider', 'timePicker'].reduce(function (maker, name) {
      maker[name] = creatorFactory(name);
      return maker;
    }, maker);
